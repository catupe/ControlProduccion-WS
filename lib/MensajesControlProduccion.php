<?php
    ...
    class MensajesControlProduccion{

        private static $instancia;
       
        private $mensajes = array
								("000"	=>	"",
								 "001"	=>	"No existe ese proyecto o esa versi&oacute;n.",
								 "002"	=>	"No existe esa versi&oacute;n de producto.",
								 "003"	=>	"No existe ese proyecto.",
								 "ADM_USR_004"=>"Error al preparar la consulta.",
								 "005"	=>	"ID incorrecto.",
								 "006"=>"Se devolvieron solo los primeros #CANT# registros.",
